(function () {
    ...
    var userViewModule = angular.module('userViewModule', ['designer']);

    angular.module('designer').requires.push('expander', 'userViewModule');

    userViewModule.controller('UserCtrl', ['$scope', 'propertyService', function ($scope, propertyService) {
