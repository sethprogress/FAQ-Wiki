...
{
    /// <summary>
    /// This class represents the controller of the MVC forms text field for DD.
    /// </summary>
    [DatabaseMapping(UserFriendlyDataType.ShortText)]
    [Localization(typeof(FieldResources))]

    public class DDTextFieldController : FormFieldControllerBase<ITextFieldModel>

    {
        public DDTextFieldController()
        {
